...
for xd in range(10000):
	...
	d='SM-G910S Build/KOT49H)'
	e=random.randrange(100, 9999)
	f='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.517'
...
for x in range(10):
	...
	i='LG-M210 Build/NRD90U)'
	j=random.randrange(1, 9)
	k=random.randrange(1, 9)
	l='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.87 Mobile Safari/537.36'
